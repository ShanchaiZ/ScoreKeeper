...
//Scorekeepering logic 1: Take the current score for player 1 then increase it by 1 and then update it on the display for player 1. Once player 1 reaches the winning score = gameover. Repeat logic with player 2.
//----------------------------------------------------
...
//Scorekeepering logic 2: Once ANY player reaches the game winning score === gameover. Therefore, Another way to think about it is, are we we STILL playing the game once the winningScore is reached ==> Boolean logic.
//----------------------------------------------------
